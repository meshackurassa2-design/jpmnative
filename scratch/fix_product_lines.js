...
const startIndex = lines.findIndex(l => l.includes('{/* Dots Indicator */}'));
const endIndex = lines.findIndex((l, i) => i > startIndex && l.includes('{(product as any).is_mystery_box && ('));
...
`;
  ...
  lines.splice(startIndex, endIndex - startIndex, goodContent);
  fs.writeFileSync(path, lines.join('\n'), 'utf8');
  console.log("Successfully patched using line indices.");
} else {
