  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.leftSidebar, { borderColor: colors.border }]}>
        ...
        {user && (
          <TouchableOpacity style={[styles.userBadge, { borderTopColor: colors.border }]} onPress={() => router.push('/wallet')}>
            <Ionicons name="wallet-outline" size={24} color={colors.text} />
            <Text style={[styles.userBadgeText, { color: colors.text }]}>Rewards Wallet</Text>
          </TouchableOpacity>
        )}
      </View>
