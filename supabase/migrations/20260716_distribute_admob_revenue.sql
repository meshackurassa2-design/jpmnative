-- Add paid_views_count to track which views have already been paid for
ALTER TABLE posts ADD COLUMN IF NOT EXISTS paid_views_count bigint DEFAULT 0;

-- Function to distribute AdMob revenue fairly
