...
import {
  ...
  ActivityIndicator, Alert, Modal, TextInput, KeyboardAvoidingView, ScrollView, Platform, Linking
} from 'react-native'
      ...
      <ScrollView contentContainerStyle={{ padding: 24 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.balanceContainer}>
          ...
          <View style={styles.balanceRow}>
            <Text style={styles.balanceCurrency}>TSH</Text>
            <Text style={styles.balanceValue}>{balance.toLocaleString()}</Text>
          </View>
          <Text style={styles.balanceSub}>For Marketplace & AI Video Generation</Text>
        </View>
...
const getStyles = (colors: any) => StyleSheet.create({
  ...
  balanceContainer: { alignItems: 'center', marginVertical: 32 },
  balanceLabel: { fontSize: 13, color: colors.textDim, textTransform: 'uppercase', letterSpacing: 1, marginBottom: 12 },
  balanceRow: { flexDirection: 'row', alignItems: 'flex-start' },
  balanceCurrency: { fontSize: 18, color: colors.textDim, fontWeight: '600', marginTop: 6, marginRight: 6 },
  balanceValue: { fontSize: 48, color: colors.text, fontWeight: '300', letterSpacing: -1.5 },
  balanceSub: { fontSize: 13, color: colors.textDim, marginTop: 12 },
