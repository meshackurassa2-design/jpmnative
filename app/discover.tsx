  ...
  const renderCard = (item: any) => {
    ...
    return (
      <View style={styles.card}>
        {isPromoted && (
          <View style={{ position: 'absolute', top: 16, left: 16, zIndex: 10, backgroundColor: '#3b82f6', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12, flexDirection: 'row', alignItems: 'center' }}>
            <Ionicons name="rocket" size={14} color="#fff" />
            <Text style={{ color: '#fff', fontSize: 12, fontWeight: '800', marginLeft: 4 }}>PROMOTED</Text>
          </View>
        )}
        {hasImage ? (
          ...
          <View style={[styles.image, { backgroundColor: '#111', justifyContent: 'center', alignItems: 'center' }]}>
            <Ionicons name="cart" size={60} color="#333" />
          </View>
        )}
          ...
          <View>
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              ...
              {(item.review_count >= 10 || item.rating >= 4.5) && (
                <Ionicons name="checkmark-circle" size={14} color="#3b82f6" style={{ marginLeft: 4, marginBottom: 4 }} />
              )}
            </View>
...
const styles = StyleSheet.create({
  ...
  card: { flex: 1, borderRadius: 24, overflow: 'hidden', backgroundColor: '#111', borderWidth: 1, borderColor: '#222' },
  image: { width: '100%', height: '100%' },
  
  gradient: { position: 'absolute', bottom: 0, left: 0, right: 0, height: '50%', backgroundColor: 'rgba(0,0,0,0.8)' },
  
  info: { position: 'absolute', bottom: 0, left: 0, right: 0, padding: 24, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-end' },
  shopName: { color: '#ec4899', fontSize: 14, fontWeight: '700', marginBottom: 4, textTransform: 'uppercase', letterSpacing: 1 },
  name: { color: '#fff', fontSize: 24, fontWeight: '800', width: width * 0.55 },
  priceTag: { backgroundColor: 'rgba(255,255,255,0.1)', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)' },
  price: { color: '#fff', fontSize: 20, fontWeight: '800' },
  
  likeBadge: { position: 'absolute', top: 40, left: 40, zIndex: 10, borderWidth: 4, borderColor: '#ec4899', borderRadius: 10, padding: 8, transform: [{ rotate: '-20deg' }] },
  likeBadgeText: { color: '#ec4899', fontSize: 32, fontWeight: '900', letterSpacing: 2 },
  ...
  controlBtn: { width: 64, height: 64, borderRadius: 32, backgroundColor: '#111', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#333' },
  
  center: { flex: 1, justifyContent: 'center', alignItems: 'center', gap: 16 },
  loadingText: { color: '#71717a', fontSize: 16, fontWeight: '600' },
  doneText: { color: '#fff', fontSize: 24, fontWeight: '800' },
  backBtn: { marginTop: 24, backgroundColor: '#6366f1', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 24 },
