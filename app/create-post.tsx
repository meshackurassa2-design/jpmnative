...
const DICT = {
  en: {
    ...
    copyright_body: 'By posting this media you confirm you own all rights to it. Dapaz is not responsible for copyright violations.',
  ...
  sw: {
    ...
    copyright_body: 'Kwa kupakia maudhui haya, unathibitisha kwamba una haki zote za maudhui hayo. Dapaz haitawajibika kwa ukiukaji wa hakimiliki.',
  ...
  suk: {
    ...
    copyright_title: 'Umiliki wa Maudhui',
    copyright_body: 'Kwa kubika vitu hivi, unasema una haki zote. Dapaz haitawajibika kwa matatizo ya hakimiliki.',
  ...
  cha: {
    ...
    copyright_body: 'Kwa kuwika vitu hivi, unasema una haki zote. Dapaz haitawajibika kwa matatizo ya hakimiliki.',
    copyright_point1: 'Nina haki za vitu hivi',
    copyright_point2: 'Havikui haki za wengine',
    copyright_point3: 'Naelewa ukiukaji unaweza kusababisha kuondolewa',
  ...
  maa: {
    ...
    copyright_body: 'Iyiolo itodua ino, isujaa ina enkiama pooki. Dapaz mme enkijapata e inkishu.',
